            ...
            <div className="flex flex-col justify-between items-start gap-[2.813rem]">
                ...
                <div className="flex flex-col w-[50%] pr-[2.813rem]">
                    ...
                    <div className={`flex items-center border-1 border-[#CED4DA] rounded-[6px] outline-none px-[0.625rem] py-[0.875rem] cursor-pointer h-[55px] relative ${submitErrors.department_id ? "border-red-main" : ""}`} onClick={() => handleDropwdown()}>
                        ...
                        {dropDown && 
                            <div className={`absolute left-0 bg-white w-full origin-top-left bottom-0 translate-y-[100%] border-1 border-[#CED4DA] rounded-[6px] z-10 max-h-[200px] select-none overflow-y-auto`}>
